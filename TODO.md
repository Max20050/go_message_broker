[ ] - Proper way of closing goroutines using a single cancel function.
[ ] - Implement a worker pool for the connections and the communication to avoid having 1000 small routines.
